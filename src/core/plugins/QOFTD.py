...
class QOFTD:
    def __init__(self) -> None:
        ...
        self.questions: list[str] = [
            ...
            "What are the most beautiful aspects that you want to have in the people you know or in the people you will know in the future?",
            "What is thing that you hate so much but people do to you that make you never want to know it again?",
            "if you watched a sad movie, will you get emotional about it?"
        ]
